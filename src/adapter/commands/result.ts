...
import { makePlayerObject } from '../../application/functions/makeObject';
import { Calculate, NewCalculate } from '../../application/types/calculate';
import { Game, NewGame } from '../../application/types/game';
import { Player } from '../../application/types/player';
